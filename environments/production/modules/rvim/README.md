...
1. [Setup - The basics of getting started with rvim](#setup)
    * [What rvim affects](#what-rvim-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with rvim](#beginning-with-rvim)
